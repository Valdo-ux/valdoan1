    ...
    <section class="flex flex-col md:flex-row items-center justify-between px-8 md:px-16 py-12 bg-custom-green">
        <div class="md:w-1/2 mb-8 md:mb-0">
            ...
            <div class="flex space-x-4">
                <a href="{{ route('login') }}" class="border border-white text-white px-4 py-2 rounded hover:bg-white hover:text-green-700 font-semibold">Login</a>
                <a href="{{ route('register') }}" class="border border-white text-white px-4 py-2 rounded hover:bg-white hover:text-green-700 font-semibold">Register</a>
            </div>
        </div>
        <div class="md:w-1/2">
            <div class="relative">
